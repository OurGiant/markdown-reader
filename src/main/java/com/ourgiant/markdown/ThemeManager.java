 ...
 *  Controls the Swing look-and-feel (window chrome, buttons, menus) — distinct from the
 *  app's own {@code RetroTheme}s, which style the rendered markdown content itself. */
